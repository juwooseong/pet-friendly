...
/**
 * 마이페이지 사용자 프로필 관리 REST Controller
 */
...
public class UserController {
    ...
    @Operation(
            ...
            description = "JWT 인증을 통해 현재 로그인한 사용자 본인의 프로필 정보를 조회합니다.",
    ...
    public ResponseEntity<ApiResponse<UserProfileResponseDto>> getMyProfile(
        ...
        UserProfileResponseDto result = userProfileService.getMyProfile(userDetails.getId());
